...
set -gx VIRTUAL_ENV /Users/mayizhuoran/PycharmProjects/ma_anastasia/restaurant_client/.venv
...
if test -n restaurant-client-py3.12
    set -gx VIRTUAL_ENV_PROMPT restaurant-client-py3.12
else
